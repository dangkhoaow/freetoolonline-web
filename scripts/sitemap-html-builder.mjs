...
function classifyGuide(slug) {
  ...
  if (/(^|-)(solar-system|black-hole|galaxy|planet|space-3d|earth-3d|sagittarius|red-giant|supernova|chandrasekhar|standard-candle|helioseismology|pulsar|stellar-spectral)/.test(slug)) {
    return 'space';
  }
