...
function classifyGuide(slug) {
  ...
  if (/(^|-)(solar-system|black-hole|galaxy|planet|space-3d|earth-3d|sagittarius|red-giant|supernova|chandrasekhar|standard-candle|helioseismology|pulsar|stellar-spectral|yorp|kreutz|sungrazing|atmospheric-refraction|refraction|green-flash)/.test(slug)) {
    return 'space';
  }
...
const LMENU_ICON_CONTENT_FIX = '<style>#menu-content-id .fa-gamepad:before{content:"\\f11b"}#menu-content-id .fa-globe:before{content:"\\f0ac"}#menu-content-id .fa-newspaper-o:before{content:"\\f1ea"}#menu-content-id .fa-paw:before{content:"\\f1b0"}</style>';
