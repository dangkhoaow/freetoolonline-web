const SEO_CLUSTER_GROUPS = [
  ...
  },
  {
    ...
    routes: ['/space-3d/solar-system.html', '/space-3d/black-hole.html', '/space-3d/galaxy.html', '/space-3d/earth-3d-globe.html', '/space-3d/moon-phases-3d.html', '/space-3d/saturn-rings.html'],
  },
