const SEO_CLUSTER_GROUPS = [
  ...
  },
  {
    ...
    routes: ['/heic-to-jpg.html', '/svg-to-png.html', '/png-to-svg.html', '/image-to-base64.html', '/base64-to-image.html', '/extract-gif-to-image-frames.html', '/image-converter-tools/audio-converter.html', '/image-converter-tools/png-to-webp.html', '/image-converter-tools/jpg-to-webp.html', '/image-converter-tools/webp-to-png.html', '/image-converter-tools/webp-to-jpg.html', '/image-converter-tools/image-to-webp.html', '/image-converter-tools/png-to-jpg.html', '/image-converter-tools/image-format-converter.html', '/image-converter-tools/jpg-to-avif-converter.html', '/image-converter-tools/client-side-pdf-editor-toolkit.html', '/image-converter-tools/hilbert-editor.html', '/image-converter-tools/devtools-style-pdf-element-inspector-editor-android.html'],
  },
  {
    cluster: 'pdf',
    hubRoute: '/pdf-tools.html',
    hubLabel: 'Back to PDF Tools',
    routes: ['/compose-pdf.html', '/split-pdf-by-range.html', '/split-pdf-to-each-pages.html', '/join-pdf-from-multiple-files.html', '/protect-pdf-by-password.html', '/remove-pdf-password.html', '/preflight-pdf.html', '/flatten-pdf.html', '/pdf-to-text.html', '/pdf-to-images.html', '/pdf-to-html.html', '/images-to-pdf.html', '/pdf-tools/pdf-filler-form-editor.html', '/pdf-tools/rotate-pdf.html', '/pdf-tools/delete-pdf-pages.html', '/pdf-tools/add-watermark-to-pdf.html', '/pdf-tools/add-page-numbers-to-pdf.html', '/pdf-tools/organize-pdf-pages.html', '/pdf-tools/pdf-compressor.html', '/pdf-tools/sign-pdf.html', '/pdf-tools/pdf-editor-online.html', '/pdf-tools/chat-with-pdf.html', '/pdf-tools/ocr-pdf.html'],
  },
  {
    cluster: 'developer',
