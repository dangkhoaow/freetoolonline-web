const SEO_CLUSTER_GROUPS = [
  ...
  },
  {
    ...
    routes: ['/compose-pdf.html', '/split-pdf-by-range.html', '/split-pdf-to-each-pages.html', '/join-pdf-from-multiple-files.html', '/protect-pdf-by-password.html', '/remove-pdf-password.html', '/preflight-pdf.html', '/flatten-pdf.html', '/pdf-to-text.html', '/pdf-to-images.html', '/pdf-to-html.html', '/images-to-pdf.html', '/pdf-tools/pdf-filler-form-editor.html', '/pdf-tools/rotate-pdf.html', '/pdf-tools/delete-pdf-pages.html', '/pdf-tools/add-watermark-to-pdf.html', '/pdf-tools/add-page-numbers-to-pdf.html', '/pdf-tools/organize-pdf-pages.html', '/pdf-tools/pdf-compressor.html', '/pdf-tools/sign-pdf.html', '/pdf-tools/pdf-editor-online.html'],
  },
  {
    cluster: 'developer',
